...
class DanEmailServices:
    def SendEmailToken(email_to, generateToken):
        ...
        email_header = 'Verificación de Correo electrónico - DANTEAI2023'
        ...
        <table style="width: 94%; max-width: 900px; border: none; border-spacing: 0; text-align: left; font-size: 16px; line-height: 22px; color: #363636;">
            <tr>
                <td style="padding:40px 30px 30px 30px; text-align:center; font-size:24px; font-weight: bold;">
                    ...
                    <h1 style="color: ghostwhite; margin-left: 1%; text-align: center; font-family: Arial,sans-serif;">DanteIA2023<hr style="color: aliceblue; margin-top: 5%;"></h1>
                </td>
            </tr>
            <tr>
                <td style="padding: 30px; ">
                    <h1 style="margin-top: 0; margin-bottom: 16px; font-size: 26px; line-height: 32px; font-weight: bold; letter-spacing: -0.02em; color: aliceblue; font-family: Arial,sans-serif;">Bienvenido a DANTEAI2023</h1>
